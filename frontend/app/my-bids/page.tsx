...
export default function MyBidsPage() {
  ...
  return (
    <div className="p-4">
      ...
      <button
        onClick={() => router.back()}
        className="cursor-pointer mb-4 px-4 py-2 bg-gray-100 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-100 rounded-full shadow transition"
      >
        ← 
      </button>
